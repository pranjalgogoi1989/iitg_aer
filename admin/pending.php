...
$title='Pending Application for Alumni card';
                ...
                <div class="col-sm-12">
                    <div class="card-body">
                        ...
                        <table id="example" class="table table-hover table-display" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $stmt = $pdo->prepare("SELECT * FROM applications where application_status='Submitted' and roll_no not in (select roll_no from accepted_applications) order by roll_no asc");
                                $stmt->execute();
                                ...
                                foreach ($students as $stud) {
                                    ...
                                    echo '<td><a href="process.php?id='.$stud['roll_no'].'" class="btn btn-primary">Process</a></td>';
                                    echo '</tr>';
                                }
                                ?>
                            </tbody>
