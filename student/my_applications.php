    ...
    <div class="row">
        ...
        <div class="card">
            <div class="d-flex align-items-top row">
                <div class="col-sm-12">
                    <div class="card-body">
                        <h5 class="card-title text-primary">My Application for Alumni card</h5>
                        <table id="example" class="table table-hover table-display" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $stmt = $pdo->prepare("SELECT * FROM applications where application_status='Submitted' and alt_email=? order by roll_no asc");
