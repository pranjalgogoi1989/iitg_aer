...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <input type="text" name="roll_number" id="roll_number" class="form-control" value="<?=$appl['roll_no'] ?? ''?>">
    </div>
    <div class="col-sm-4">
...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <input type="text" name="whatsapp" id="whatsapp" class="form-control" value="<?=$appl['whatsapp'] ?? ''?>">
    </div>
</div>
<div class="row">
    <div class="col-sm-6">
